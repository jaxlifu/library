...
public class WheelTime {
    ...
    public String getTime() {
        return String.valueOf((wv_year.getCurrentItem() + START_YEAR)) + "-" + (wv_month.getCurrentItem() + 1) + "-" + (wv_day.getCurrentItem() + 1) + " " + wv_hours.getCurrentItem() + ":" + wv_mins.getCurrentItem();
    }
}
